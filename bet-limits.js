define(['./utils/ui/login/login'], function (loginHelper) {
    ...
    var depositLimitsDropdownSelectors = ['#daybetlimit', '#weekbetlimit', '#monthbetlimit'];
            ...
            .isElementPresent('.fn-open-menu', function(isPresent){
                if(isPresent) {
                   ...
                   task.ui
                        ...
                        .waitForElement('.fn-bet-limits', 5000);
                } else {
                    task.ui
    ...
    return function (task, config) {
        task('Bet limits', function (task) {
            ...
            task.step('Set loss limits values', function (done) {
                 task.ui
                   .click('[name="daybetlimit"]')
                   .setValue('[name="daybetlimit"]', 100)
                   .click('[name="weekbetlimit"]')
                   .setValue('[name="weekbetlimit"]', 200)
                   .click('[name="monthbetlimit"]')
                   .setValue('[name="monthbetlimit"]', 300)
                   .end(done);
                /*
            ...
            task.step('Check message', function (done) {
                task.ui
                    .click('.fn-bet-limits [type="submit"]')
                    .pause(1000)
                    /*
