define(['./utils/ui/helpers/helpers'], function (helpers) {
    var isDailyWeeklyMonthlyLimitsPresent = [Boolean(0), Boolean(0), Boolean(0)];
    var depositLimitsDropdownSelectors = ['#daydepositlimit', '#weekdepositlimit', '#monthdepositlimit'];
        ...
        task.ui
            .isElementPresent('.fn-open-menu', function(isPresent){
                if(isPresent) {
                    task.ui
                        .click('.fn-open-menu')
                        .waitForElement('li[data-url="/deposit-limits"] a')
                        .click('li[data-url="/deposit-limits"] a');
                } else {
                    task.ui
    ...
    return function (task, config) {
        task('Deposit limits', function (task) {
            ...
            task.step('Check message', function (done) {
                task.ui
                    .click('.fn-deposit-limits [type="submit"]')
                    .pause(1000)
